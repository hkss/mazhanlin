<template>
  <div class="main_con">
    <select v-model="pinlun">
      ...
      <option v-for="val in maintain" :key="val.id" value="val.name">{{val.name}}</option>
    </select>
    <table border="1" cellpadding="20px">
      ...
      <tbody>
        <tr v-for="(item,index) in main_con" :key="item.id">
